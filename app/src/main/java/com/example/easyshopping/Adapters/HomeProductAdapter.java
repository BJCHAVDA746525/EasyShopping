...
public class HomeProductAdapter extends RecyclerView.Adapter<HomeProductAdapter.viewholder>  {
    ...
    public HomeProductAdapter(ArrayList<Room_Product_Model> product_list, Context context) {
    ...
    public HomeProductAdapter.viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.home_recycler_layout, parent, false);
    ...
    public int getItemCount() {
        return Product_list != null ? Product_list.size() : 0;
    }
